...
copper:
       ;MOVE  ADR,DATA 
       dc.w BPLCON0,$0200          ; MOVE INTSTTRUCTON set number of bitplanes to zero
       ;dc.w $0100,$0200            
       
       ;WAIT  POS,MASK
       dc.w $ffff,$fffe            ; WAIT INSTRUCTION for scan line at "impossible" position $fffe
                                   ; VP=$FF = line 255. Wait until beam reaches the last line. 
                                   ; HP=$FE = max col is $E2; FE will never be reached.
                                   ; This a typical "wait until next vblank interval"