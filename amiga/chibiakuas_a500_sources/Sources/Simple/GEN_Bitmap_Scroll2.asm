...
;HSCROLL is in VRAM
	...
	;DC04-DC08 are line scrolls	
	move.l #$DC22,d2			;Scroll-B
	jsr prepareVram
	move.w d3,(VDP_data)		;Send the tile data to the VDP

	move.l #$DC42,d2			;Scroll-B
	jsr prepareVram
	move.w d4,(VDP_data)		;Send the tile data to the VDP
...
;Line 2
	move.l #$40040010,d1		;Scroll-A
	move.l d1,(VDP_Ctrl)
	move.w d3,(VDP_data)		;Send the tile data to the VDP
	
;Line 3
	move.l #$40080010,d1		;Scroll-A
	move.l d1,(VDP_Ctrl)
	move.w d4,(VDP_data)		;Send the tile data to the VDP
