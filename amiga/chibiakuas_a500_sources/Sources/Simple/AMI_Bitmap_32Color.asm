...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	;Specify 5 Bitplanes (32 color)
	
; 		      FEDCBA9876543210
; 			  RPPPHDCG----PIE-	 		;PPP=Bitplanes (0-6) D=Double playfield (2 layers)
	move.w	#%0101001000000000,BPLCON0	;Bitplane control register (misc. control bits)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   ;Define Memory layout
	...
	move.l #Screen_Mem+(40*200*1),d0	;Bitplane 1
	...
	move.l #Screen_Mem+(40*200*2),d0	;Bitplane 2
	...
	move.l #Screen_Mem+(40*200*3),d0	;Bitplane 3
	...
	move.l #Screen_Mem+(40*200*4),d0	;Bitplane 4
...
BmpNextLine:			
	...
	move.l a6,-(sp)
BmpNextPixel:
		move.b (a0)+,(a6)			;Bitplane 0 - 2 colors
		move.b (a0)+,(40*200*1,a6)	;Bitplane 1 - 4 colors
		move.b (a0)+,(40*200*2,a6)	;Bitplane 2 - 8 colors
		move.b (a0)+,(40*200*3,a6) 	;Bitplane 3 - 16 colors
		move.b (a0)+,(40*200*4,a6) 	;Bitplane 4 - 32 colors
...
Bitmap:
	incbin "\ResALL\Sprites\RawAMI_32col.RAW"
BitmapEnd:
...
Screen_Mem:						;This is our screen
	ds.b    320*200*5			;320x200 5 bitplanes (32 color)
