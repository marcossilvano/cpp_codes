...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	move.l #label1,a0			;Move with Absolute 
	lea label1,a1				;LEA with absolute
	
	move.l (5,a0),a2			;Move with offset
	lea (5,a0),a3				;LEA with offset

	move.l (label1,pc),a4		;Move with PC relative
	lea (label1,pc),a5			;Lea with PC relative
...
; DbraTest:
	...
	; dbra d0,DbraTest		;Decrement and Branch until below zero 
