...
FillLut2:	
	...
	move.l #(TestChibiko_End-TestChibiko)-1,d0
	move.l #TestChibiko,a0
	move.l #TestChibikoRev,a1
	move.l #FlipLUT,a2
FlipSprites:	
	move.b (a0)+,d1
	move.b (a2,d1),d1
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;	
	...
	jsr InstallInterruptHandler	;Install Interrupt handler
...
GetScreenPos: ; d1=x d2=y - returns screen address in A6
	moveM.l d1-d4,-(sp)
		and.l #%11111100,d1		;Clear all but the bottom byte
		lsr.l #2,d1
		and.l #$FF,d4
...
NoClear:
	...
	move.l a1,(BLTBPTH)	;Sprite source
...
EvenByte:	
	...
	move.w #%0000100000000010,(BLTSIZE)
...
InstallInterruptHandler:
	...
	move.l $00000004,a6			;Get OS pointer
	
	move.l #MyInt,a1 			;interrupt = Interrupt structure
	moveq.l #5,d0				;intNum 5 = INTB_VERTB (vblank)
	jsr	(-168,a6)				;-168 = Exec - AddIntServer
...
MyInt:
	...
	dc.b 2,127						;LN_TYPE (2=NT_INTERRUPT),LN_PRI
	dc.l MyIntName					;LN_NAME
	dc.l MyData,InterruptHandler	;IS_DATA,IS_CODE
	
MyIntName: dc.b "MYinterrupt",0		;Do we need a name??!!
	even
	
MyData:	dc.l 0	;Test Data (A1 points here on interrupt)

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;


;See Page 166 of Amiga Intern 1992

;A1=IS_DATA
;A0 must retain the value $DFF000 if pri>10
;Set Z flag to run other intterupt routines on exit
...
InterruptHandler:
	moveM.l d2-d7/a0-a6,-(sp)
			...
			addq.l #1,(a1)		;Alter MyData (Just a test!)
			
	moveM.l (sp)+,d2-d7/a0-a6	;D0/D1 are ok to change
	
	moveq.l #0,d0				;Zflag = Continue other interrupts
	rts
...
TestChibiko_End:
TestChibikoRev:
	ds.b TestChibiko_End-TestChibiko
