...
userReq_Game:
	...
	move.w #$0FF0,$400028	;4
	move.w #$0FF0,$40002A	;5
	move.w #$0FF0,$40002C	;6
	move.w #$0FF0,$40002E	;7
	move.w #$0FF0,$400030	;8
	move.w #$0FF0,$400032	;9
	move.w #$0FF0,$400034	;10
	move.w #$0FF0,$400036	;11
	move.w #$0FF0,$400038	;12
	move.w #$0FF0,$40003C	;13
	move.w #$0FF0,$40003C	;14
