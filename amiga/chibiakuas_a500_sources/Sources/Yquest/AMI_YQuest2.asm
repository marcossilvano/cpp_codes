...
NextBitplane:
		...
		;2nd Byte
			and.b d1,(1,a2)		;Remove bits we're going to write 00000011
			move.b (a3)+,d5		;Get bitmap
			lsl.b d6,d5			;Shift into position			  345678--
			or.b d5,(1,a2)		;Or in to background
			
			add.l #40*200,a2	;Move to next bitplane
			
			dbra d3,NextBitplane
	...
	rts
		...
		;2nd byte separation test
			;and.b d1,(1+160,a2)		;Remove bits we're going to write 00000111
			;move.b (a3)+,d5		;Get bitmap
			;lsl.b d6,d5			;Shift into position			  45678---
			;or.b d5,(1+160,a2)		;Or in to background
