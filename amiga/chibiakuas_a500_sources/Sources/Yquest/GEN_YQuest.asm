...
;Define patterns	
	...
	move.l #0*32,d2				;32 bytes per tile - Start Tile 0
	jsr DefineTiles	
...
;show title screen	
	move.l #titlepic,a3		;Title Picture
	move.l #0,d4
titlepixnexty:
	move.l #0,d1
titlepixnextx:
...
PrintChar:
	moveM.l d0-d7/a3,-(sp)
		and.l #$FF,d0
		sub.l #32,d0		;Now Chars below 32
		clr.l d1
		clr.l d4
		move.b (CursorX),d1	;Get Cursor Pos
		move.b (CursorY),d4
		
		jsr showsprite		;Show Char
		
		addq.b #1,(CursorX)	;Move along screen
	moveM.l (sp)+,d0-d7/a3
	rts
