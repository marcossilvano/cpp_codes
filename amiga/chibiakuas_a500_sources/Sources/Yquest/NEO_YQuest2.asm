...
;Allocate Hardware sprite numbers 
	move.l #2,d4
...
Cls:
	...
	move.l #40*32,d0
Cls_Again:	
	move.w #$1800,$3C0002	;tile data (Zero STile)
	dbra d0,Cls_Again
	
	move.w #64,d0			;Sprites to clea
CLS_NextSprite:	
	jsr BlankSpriteHard		;Clear one
...
BlankSpriteNoReturn:
	...
	move.b (O_HSprNum,a4),d0	;kill the bullet
...
DoGetHSpriteObj:
	moveM.l d0-d7,-(sp)
		moveM.l d0,-(sp)
			...
			lsl.l #4,d0 			;16 sprites per bank
			
			add.b (O_SprNum,A4),d0	;Sprite Source
			
			ifnd BuildNEO_CD
				add.l #$2200,d0		;add $2200 on NON CD systems
			endif
		...
		clr.l d1
		move.b (O_Xpos,A4),d1
		lsl.l #1,d1				;Internal co-rds work in pairs of pixels
		
		clr.l d5
		move.b (O_Ypos,A4),d5
		move.l #288+208,d2		;Ypos
		sub.l d5,d2				;NeoGeo Y co-ords are from bottom of screen
