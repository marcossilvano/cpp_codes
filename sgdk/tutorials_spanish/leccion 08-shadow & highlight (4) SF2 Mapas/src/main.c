...
/*
    ...
    VDP_setTileMapDataRectEx(VDP_BG_A, &tilemap_buffer[0], 0,
...
*/
    ...
    //VDP_drawImageEx(VDP_BG_B, &bg_B_real, TILE_ATTR_FULL(PAL0, 0, 0, 0, 1), SCENARIO_POS_X, SCENARIO_POS_Y, FALSE, CPU);
